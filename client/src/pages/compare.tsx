        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">Living Book Creator - Compare Documents</h1>
                <p className="text-xs text-gray-500">Two-Document Analysis & Processing</p>
              </div>
            </div>
