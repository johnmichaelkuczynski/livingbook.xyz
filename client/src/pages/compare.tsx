      ...
      <Card className="h-[1400px] flex flex-col overflow-hidden">
        ...
        <CardContent className="flex-1 flex flex-col overflow-hidden p-0" style={{ height: 'calc(100% - 32px)' }}>
          {!doc ? (
            ...
            >
              <TabsList className="grid w-full grid-cols-2 mb-0 flex-shrink-0 h-8">
              ...
              <TabsContent value="text" className="flex-1 flex flex-col space-y-0" style={{ height: 'calc(100% - 32px)' }}>
                <Textarea
                ...
                />
                <div className="flex items-center justify-between flex-shrink-0 h-8">
            ...
            <div className="flex-1 flex flex-col space-y-0">
              ...
              <div className="flex-1 overflow-y-auto bg-white dark:bg-gray-800 rounded p-1" style={{ height: 'calc(100% - 24px)' }}>
